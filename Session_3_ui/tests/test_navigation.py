...
from Session_3_ui.test_data import LEARN_MORE_TEXT, IANA_HEADING, HOMEPAGE_HEADING, IANA_URL
...
@pytest.mark.parametrize(
    ...
    [
        (LEARN_MORE_TEXT, IANA_URL, IANA_HEADING)
    ]
)
...
def test_user_can_return_to_homepage_after_learn_more_navigation(homepage: Page):
    ...
    expect(homepage).to_have_url(IANA_URL)
    homepage.go_back()
